        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/add_category.php">Add Categories</a>
                    </li>
                    <li class="nav-item">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center"><?php echo ($row['Status'] == 1) ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>'; ?></td>
                                                        <td class="center"><?php echo htmlentities($row['CreationDate']); ?></td>
                                                        <td class="center"><?php echo htmlentities($row['UpdationDate']); ?></td>
                                                        <td class="center">
                                                            <a href="edit-category.php?catid=<?php echo htmlentities($row['id']); ?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button></a>
                                                            <a href="categories.php?del=<?php echo htmlentities($row['id']); ?>" onclick="return confirm('Are you sure you want to delete?');"><button class=" btn btn-danger"><i class="fa fa-pencil"></i> Delete</button></a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    $cnt++;
